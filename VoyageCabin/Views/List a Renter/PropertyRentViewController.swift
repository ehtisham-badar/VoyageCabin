//
//  PropertyRentViewController.swift
//  VoyageCabin
//
...
class PropertyRentViewController: UIViewController {
    ...
    @IBAction func onClickNext(_ sender: Any) {
        ...
        guard let vc = storyboard.instantiateViewController(withIdentifier: String(describing: PropertyPrefViewController.self)) as? PropertyPrefViewController else {
            return
        }
...
extension PropertyRentViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return accommodationTypes.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.iconImage.image = UIImage(named: "iconpr\(indexPath.item + 1)")
        cell.lblTitle.text = accommodationTypes[indexPath.item]
